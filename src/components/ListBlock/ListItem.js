...
const ListItem = ({delTask,actionDelete, successHandler, action, task, item, setModalShowObj,setCheck,setCheckTags,setModalShow,itemLeft,itemRight,priority,priorityCircle,date,dateIcon}) => {
